-- Restrict the operational day projection to schedules covering the requested day.
-- Schedule entry creation guarantees its Unit-local start date lies within this range.
...
begin
  ...
  where schedule_item.organization_id = list_presence_operational_day.target_organization_id
    and schedule_item.period_start <= list_presence_operational_day.target_date
    and schedule_item.period_end >= list_presence_operational_day.target_date
